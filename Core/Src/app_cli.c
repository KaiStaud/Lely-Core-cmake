                                 ...
                                 const char *pcCommandString)
{
    ...
    const char* pcParameter2 = FreeRTOS_CLIGetParameter
                        (
                          /* The command string itself. */
                          pcCommandString,
                          /* Return the first parameter. */
...
const CLI_Command_Definition_t xCommandList[] = {
    ...
    },
    {
        ...
        .pcHelpString = "Get IO:\r\n Read IO\r\n\r\n",
        .pxCommandInterpreter = GetIO, /* The function to run. */
        .cExpectedNumberOfParameters = 0 /* 2 parameters are expected. */
    },
    {
        .pcCommand = "moveTo",
        .pcHelpString = "moveTo:\r\n Rotate n steps\r\n\r\n",
        .pxCommandInterpreter = SetTargetPosition,
        .cExpectedNumberOfParameters = 1
    },
    {
        .pcCommand = "setRPM",
        .pcHelpString = "setRPM:\r\n Rotate with constant velocity\r\n\r\n",
        .pxCommandInterpreter = SetRPM,
        .cExpectedNumberOfParameters = 1
    },   
    {
